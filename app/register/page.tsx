    ...
    return (
        <div className="flex min-h-screen items-center justify-center">
            <div className="w-full max-w-md bg-zinc-800/30 border border-zinc-700 rounded-2xl p-8 backdrop-blur-lg shadow-2xl">
                ...
                <h1 className="text-3xl font-bold text-left mb-6 bg-linear-to-r from-indigo-500 to-blue-600 bg-clip-text text-transparent">
                    Criar Conta
                </h1>
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center">
                                <Button
                                    ...
                                    variant="outline"
                                    onClick={prevStep}
                                    className="border-zinc-600 text-zinc-300 bg-indigo-600 hover:bg-indigo-800 hover:text-zinc-300"
                                >
                ...
                <div className="flex justify-center items-center gap-2 mt-6">
                    {[1, 2].map((i) => (
                        <div
                            key={i}
                            className={`h-2 w-8 rounded-full transition-all ${step >= i ? "bg-indigo-500" : "bg-zinc-700"
                                }`}
                        ></div>
                    ))}
                </div>
